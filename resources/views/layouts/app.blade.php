...
<head>
    ...
    <title>{{ config('app.name', 'Baza książek') }}</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="#">@yield('currentNavPage')</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/aboutus') }}">O nas</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="btn btn-outline-primary" href="{{ route('login') }}">{{ __('Zaloguj się') }}</a>
                                </li>
                            @endif
                        @else
